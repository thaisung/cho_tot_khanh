...
class Category_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1CategorySerializer
...
class Company_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1CompanySerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Year_of_manufacture_ListCreateAPIView(generics.ListCreateAPIView):
    queryset = Year_of_manufacture.objects.all()
    serializer_class = B1YearOfManufactureSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            data = {'status': status.HTTP_400_BAD_REQUEST,'message':'Registration failed', 'error': serializer.errors}
            return Response(data, status=status.HTTP_400_BAD_REQUEST)
class Year_of_manufacture_RetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Year_of_manufacture.objects.all()
    serializer_class = B1YearOfManufactureSerializer
    def get_permissions(self):
        if self.request.method == 'GET':
...
class Gearbox_ListCreateAPIView(generics.ListCreateAPIView):
    queryset = Gearbox.objects.all()
    serializer_class = B1GearboxSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            data = {'status': status.HTTP_400_BAD_REQUEST,'message':'Registration failed', 'error': serializer.errors}
            return Response(data, status=status.HTTP_400_BAD_REQUEST)
class Gearbox_RetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Gearbox.objects.all()
    serializer_class = B1GearboxSerializer
    def get_permissions(self):
        if self.request.method == 'GET':
...
class Fuel_ListCreateAPIView(generics.ListCreateAPIView):
    queryset = Fuel.objects.all()
    serializer_class = B1FuelSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Fuel_RetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Fuel.objects.all()
    serializer_class = B1FuelSerializer
    def get_permissions(self):
        if self.request.method == 'GET':
...
class Guarantee_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1GuaranteeSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Seat_number_ListCreateAPIView(generics.ListCreateAPIView):
    queryset = Seat_number.objects.all()
    serializer_class = B1SeatNumberSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            data = {'status': status.HTTP_400_BAD_REQUEST,'message':'Registration failed', 'error': serializer.errors}
            return Response(data, status=status.HTTP_400_BAD_REQUEST)
class Seat_number_RetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Seat_number.objects.all()
    serializer_class = B1SeatNumberSerializer
    def get_permissions(self):
        if self.request.method == 'GET':
...
class Usage_status_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1UsageStatusSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Seller_information_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1SellerInformationSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Capacity_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1CapacitySerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Items_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    filterset_fields = ['id','User__username','Map','Location__Name','Address__Name','Category__Name','Usage_status__Name','Seller_information__Name',
                        'Guarantee__Name','Company__Name','Year_of_manufacture__Name','Gearbox__Name','Fuel__Name','Seat_number__Name','Capacity__Name',
                        'Free_giveaway','Price','Title','Detailed_description']
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            year_of_manufacture_id = request.data.get('Year_of_manufacture')
            year_of_manufacture = Year_of_manufacture.objects.get(pk=year_of_manufacture_id) if year_of_manufacture_id else None

            gearbox_id = request.data.get('Gearbox')
            gearbox = Gearbox.objects.get(pk=gearbox_id) if gearbox_id else None

            fuel_id = request.data.get('Fuel')
            fuel = Fuel.objects.get(pk=fuel_id) if fuel_id else None

            seat_number_id = request.data.get('Seat_number')
            seat_number = Seat_number.objects.get(pk=seat_number_id) if seat_number_id else None
            ...
            item_instance = serializer.save(User=request.user, Location=location, Address=address,
                                            ...
                                            Guarantee=guarantee,Company=company,Year_of_manufacture=year_of_manufacture,Gearbox=gearbox,
                                            Fuel=fuel,Seat_number=seat_number,Capacity=capacity)
...
class Items_image_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B1Items_image_Serializer
