...
class Category_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B5CategorySerializer
...
class Seller_information_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B5SellerInformationSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['id','Name']
    search_fields = ['id','Name']
    def get_permissions(self):
...
class Items_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    filterset_fields = ['id','User__username','Map','Location__Name','Address__Name','Category__Name',
                        'Seller_information__Name','Free_giveaway','Price','Title','Detailed_description']

    search_fields = ['id','User__username','Map','Location__Name','Address__Name','Category__Name',
                       'Seller_information__Name','Free_giveaway','Price','Title','Detailed_description']
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            item_instance = serializer.save(User=request.user, Location=location, Address=address,
                                            Category=category,Seller_information=seller_information )
...
class Items_image_ListCreateAPIView(generics.ListCreateAPIView):
    ...
    serializer_class = B5Items_image_Serializer
