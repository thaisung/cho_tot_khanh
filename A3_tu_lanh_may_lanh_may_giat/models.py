...
class Items(models.Model):
    ...
    Volume = models.ForeignKey(Volume,on_delete=models.CASCADE, related_name='Items_Volume_A3',verbose_name='Thể tích',default=None,null=True, blank=True)
    Wattage = models.ForeignKey(Wattage, on_delete=models.CASCADE, related_name='Items_Wattage_A3',verbose_name='Công suất',default=None,null=True, blank=True)
    Washing_volume = models.ForeignKey(Washing_volume, on_delete=models.CASCADE, related_name='Items_Washing_volume_A3',verbose_name='Khối lượng giặt',default=None, null=True, blank=True)
